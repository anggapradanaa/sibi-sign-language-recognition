...
# ========== KONFIGURASI PATH ==========
OLD_MODEL_PATH = r"D:\Perkuliahan\Semester 7\Skripsi\Sistem Isyarat Bahasa Indonesia (SIBI)\ResNet50\sibi_resnet50_model_v5.h5"
NEW_MODEL_PATH = r"D:\Perkuliahan\Semester 7\Skripsi\Sistem Isyarat Bahasa Indonesia (SIBI)\ResNet50\sibi_resnet50_v5_savedmodel"
LABELS_PATH = r"D:\Perkuliahan\Semester 7\Skripsi\Sistem Isyarat Bahasa Indonesia (SIBI)\ResNet50\labels_list_v5.npy"

print("="*60)
print("REBUILD MODEL RESNET50 DARI WEIGHTS")
print("="*60)
...
# Rebuild arsitektur model (sesuaikan dengan script training Anda)
print("\n[2/5] Rebuilding model architecture...")
try:
    base_model = ResNet50(include_top=False, weights='imagenet', input_shape=(224, 224, 3))
    
    # Freeze layers seperti di training.
    # CATATAN: Sesuaikan jumlah layer yang di-freeze jika berbeda di script training Anda.
    # Contoh: for layer in base_model.layers[:-10]: layer.trainable = False
...
print("\nLangkah selanjutnya:")
print("1. Jalankan: python deploy_resnet50.py")
